...
/**
 * Komponent odpowiedzialny za mapowanie obiektów Training na TrainingDto i w drugą stronę.
 * Zapewnia konwersję danych treningowych pomiędzy formatem używanym w warstwie persystencji a formatem przesyłania danych.
 */
@Component
public class TrainingMapper {

    /**
     * Przekształca obiekt Training na obiekt TrainingDto.
     * @param training Obiekt Training, który ma być przekonwertowany.
     ...
     * @param dto Obiekt TrainingDto, który ma być przekonwertowany na encję.
