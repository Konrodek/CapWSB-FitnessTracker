...
public class UserController {
    ...
    /**
     * Tworzenie nowego użytkownika na podstawie danych przesłanych w formacie DTO.
    ...
    /**
     * Usunięcie użytkownika na podstawie podanego identyfikatora.
     * @param id Identyfikator użytkownika, który posłuży do lokalizacji użytkownika do usunięcia.
     * @return ResponseEntity reprezentujący wynik operacji.
     */
    @DeleteMapping("/{id}")
    ...
    /**
     * Aktualizacja użytkownika na podstawie przesłanych danych w formacie DTO.
    ...
    /**
     * Szuka użytkowników wg podanego fragmentu email.
    ...
    /**
     * Wyszukuje użytkowników o wieku wyższym niż podany.
     * @param age Wiek, powyżej tej wartości będą zwracani użytkownicy.
